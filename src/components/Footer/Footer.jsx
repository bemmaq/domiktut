...
>
    ...
    <p className='text-white  pl-60 pt-5'>Оставьте заявку и мы свяжемся <br />  с вами для уточнения деталей</p>
    <button className='text-white ml-60 w-[220px] h-[50px] mt-10 rounded-3xl bg-orange-500 border-none'>Оставить заявку</button>
    </div>
    <div style={{ background: 'linear-gradient(180deg, #161723 0%, #161723 109.24%)',height:'400px' }}>
    <Container>
      <div className='flex justify-between pt-20'>
        <div>
        <img src={logo} alt="" />
        <p className='pt-[140px]' style={{color:'#404256'}}>Политика конфиденциальности</p>
        <p style={{color:'#404256'}}>Согласие на обработку персональных данных</p>
